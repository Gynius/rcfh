...
export const services = [
  {
    svg: <FaBolt className="h-6 w-6 text-red" />,
    title: "VA services",
    description:
  ...
  {
    svg: <BsFillPeopleFill className="h-6 w-6 text-red" />,
    title: "VA Staffing",
    description:
  ...
  {
    svg: <FaEnvelopeOpenText className="h-6 w-6 text-red" />,
  ...
  {
    svg: <MdWork className="h-6 w-6 text-red" />,
