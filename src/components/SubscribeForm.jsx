...
function SubscribeForm() {
  return (
    <section className=" flex justify-center bg-gray-100 " id="subscribe-form">
      <div className="subscribe-form border flex border mb-20 bg-cover bg-bottom overflow-hidden  z-10 relative">
        <div className="form-image w-1/3 h-full flex items-base justify-end p-10 z-20">
          <FaSync size={200} className="text-green_dark" />
        </div>
        <div className="form-area w-2/3 p-10 px-20 flex flex-col gap-2 z-20">
          <h2 className="font-roboto font-extrabold text-4xl text-white ">
            Subscribe Now
          </h2>
          <p className="text-gray-200 font-roboto text-base">
          ...
          />
          <button className="border w-1/2 mx-auto py-3 px-5 bg-green text-white rounded-lg hover:bg-green_dark">
            Subscribe
          </button>
