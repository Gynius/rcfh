...
function Hero() {
  return (
    <>
      <Helmet>
        <title>Discover, Delegate, Deploy | RCFH Agency</title>
        <meta
          name="description"
          content="As an Entrepreneur, you have chosen to work FOR yourself. With RCFH in your business, you’ll ensure you’re not working BY yourself!"
        />
        <meta
          name="keywords"
          content="Entrepreneur, Discover, Delegate, Deploy, Deliver, Business Support"
        />
        <meta
          property="og:title"
          content="Discover, Delegate, Deploy | RCFH Agency"
        />
        <meta
          property="og:description"
          content="Ensure you're not working by yourself with RCFH support in your business!"
        />
      ...
      <section className="bg-hero_bg bg-cover bg-bottom :bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 :text-gray-400">
            As an Entrepreneur, you have chosen to work FOR yourself…With RCFH
            in your business, you’ll ensure you’re not working BY yourself!
          </p>
